...
const EditExpert: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || "Failed to update expert profile");
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="p-6">
      <div className="flex items-center gap-4 mb-6">
        <Button variant="outline" size="icon" onClick={() => navigate("/admin/expert")}>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Club/Organization</label>
            <Input name="club" value={formData.club} onChange={handleChange} placeholder="Club/Organization" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Sport Specialty</label>
          ...
          <div>
            ...
            <Input name="subProfession" value={formData.subProfession} onChange={handleChange} placeholder="Specialization" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Certification Level</label>
            <Input name="certificationLevel" value={formData.certificationLevel} onChange={handleChange} placeholder="e.g., UEFA A, FA Level 3" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Response Time</label>
            <Input name="responseTime" value={formData.responseTime} onChange={handleChange} placeholder="e.g., Within 24 hours" />
          </div>
          <div>
        ...
        {/* Skills & Expertise */}
        <h3 className="text-lg font-medium mb-4 text-gray-900 dark:text-white">Skills & Expertise</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div>
          ...
          <div>
            ...
            <Input name="skills" value={formData.skills} onChange={handleChange} placeholder="Coaching, Analysis, ..." />
          </div>
          <div>
        ...
        <div className="flex justify-end gap-3 pt-4 border-t">
          <Button type="button" variant="outline" onClick={() => navigate("/admin/expert")}>
            Cancel
          </Button>
